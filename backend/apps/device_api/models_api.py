...
COLLECTION_TYPE_MONGO_MAP = {
    ...
    "hrp_state": hrp_state_mongo,
    "address_set": address_set_mongo,
    "nat_address": nat_address_mongo,
    "service_set": service_set_mongo,
    "slb_info": slb_info_mongo,
    "vrrp_info": vrrp_info_mongo,
    "zone": zone_mongo,
