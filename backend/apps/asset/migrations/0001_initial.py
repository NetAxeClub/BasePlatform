# Generated by Django 3.2.23 on 2025-03-27 07:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_login_user', models.CharField(max_length=200, verbose_name='用户')),
                ...
                ('admin_record_cmds', models.TextField(default='', verbose_name='命令记录')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=50, verbose_name='管理账户')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uptime', models.DateField(blank=True, editable=False, null=True, verbose_name='上线时间')),
                ...
                ('snmp_version', models.CharField(default='v2c', max_length=50, verbose_name='SNMP version')),
                ('snmp_community', models.CharField(default='-', max_length=50, verbose_name='SNMP community')),
                ('snmp_port', models.IntegerField(default=161, verbose_name='snmp port')),
                ('ssh_enable', models.CharField(choices=[('0', '不纳管'), ('account', 'account')], default='0', max_length=50, verbose_name='ssh是否纳管')),
                ('netconf_enable', models.CharField(choices=[('0', '不纳管'), ('account', 'account')], default='0', max_length=50, verbose_name='NETCONF是否纳管')),
                ('is_monitor', models.BooleanField(default=False, verbose_name='是否监控')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(default='', max_length=100, null=True, verbose_name='机房地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('u_location_start', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(50), django.core.validators.MinValueValidator(1)], verbose_name='机架位起始')),
                ('u_location_end', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(50), django.core.validators.MinValueValidator(1)], verbose_name='机架位结束')),
                ('uptime', models.DateField(auto_now_add=True, null=True, verbose_name='上线时间')),
                ('expire', models.DateField(blank=True, null=True, verbose_name='维保日期')),
                ('memo', models.TextField(blank=True, default='-', null=True, verbose_name='备注')),
                ('status', models.PositiveSmallIntegerField(choices=[(0, '在线'), (1, '下线'), (2, '挂牌'), (3, '备用')], default=0, verbose_name='状态')),
                ('ha_status', models.PositiveSmallIntegerField(choices=[(1, '主设备'), (2, '从设备'), (0, '独立设备')], default=0, verbose_name='HA状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, verbose_name='硬件型号')),
        ...
        migrations.AddField(
            ...
            name='server',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='server_bind_ip', to='asset.server', verbose_name='关联服务器'),
        ),
        migrations.AddField(
            model_name='server',
            name='account',
