        ...
        <n-tab-pane name="CMDB基本属性维护" tab="CMDB基本属性维护">
          ...
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_vendor_show = true"
                    >新增供应商
                  </n-button>
                  <n-button size="tiny" type="info" @click="add_devicetype_show = true"
                    >新增设备类型
                  </n-button>
                  <n-button size="tiny" type="info" @click="add_model_show = true"
                    >新增硬件型号
                  </n-button>
                  <n-input
                    size="tiny"
              ...
              <template #default>
                <n-data-table
                  :data="
                    model_list.slice((model_page - 1) * model_pageSize, model_page * model_pageSize)
                  "
          ...
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_role_show = true"
                    >新增设备角色
                  </n-button>
              ...
              <template #default>
                <n-data-table
                  :data="
                    role_list.slice((role_page - 1) * role_pageSize, role_page * role_pageSize)
                  "
          ...
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_netzone_show = true"
                    >新增网络区域
                  </n-button>
                  <n-input
                    size="tiny"
          ...
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_attribute_show = true"
                    >新增网络属性
                  </n-button>
                  <n-input
                    size="tiny"
          ...
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_framework_show = true"
                    >新增网络架构
                  </n-button>
                  <n-input
                    size="tiny"
          ...
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_cmdb_show = true"
                    >新增网络机房
                  </n-button>
                  <n-button size="tiny" type="success" @click="add_rack_show = true"
                    >新增网络模块
                  </n-button>
                  <n-button size="tiny" type="warning" @click="add_rack_show = true"
                    >新增网络机柜
                  </n-button>
                  <n-input
                    size="tiny"
              ...
              <template #default>
                <n-data-table
                  :data="
                    rack_list.slice((rack_page - 1) * rack_pageSize, rack_page * rack_pageSize)
                  "
        ...
        <n-tab-pane name="服务器基本属性维护" tab="服务器基本属性维护">
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_server_vendor_show = true"
                    >新增服务器供应商
                  </n-button>
                  <n-input
                    size="tiny"
          ...
          <div style="width: 100%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_server_model_show = true"
                    >新增服务器型号
                  </n-button>
                  <n-input
                    size="tiny"
        ...
        <n-tab-pane name="账户属性维护" tab="账户属性维护">
          <div style="width: 50%; display: inline-block; padding: 10px">
            ...
            <TableBody>
              <template #header>
                <n-space>
                  <n-button size="tiny" type="info" @click="add_cmdb_account_show = true"
                    >新增设备管理账户
                  </n-button>
