        ...
        <n-card title="" style="margin-bottom: 16px">
            <n-tabs type="line" animated>
                <n-tab-pane name="CMDB基本属性维护" tab="CMDB基本属性维护">
                            ...
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="硬件型号搜索" v-model:value="model_keyword"
                                        @keyup.enter.native="model_filter_func"></n-input>
                                </n-space>
                            </template>
                            <template #default>
                                <n-data-table :data="model_list.slice((model_page - 1) * model_pageSize, model_page * model_pageSize)
                            ...
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="设备角色搜索" v-model:value="role_keyword"
                                        @keyup.enter.native="role_filter_func"></n-input>
                                </n-space>
                            </template>
                            <template #default>
                                <n-data-table :data="role_list.slice((role_page - 1) * role_pageSize, role_page * role_pageSize)
                    ...
                    <div style="width: 50%; display: inline-block; padding: 10px">
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="网络区域搜索" v-model:value="netzone_keyword"
                                        @keyup.enter.native="netzone_filter_func"></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="netzone_page" :page-count="netzone_pageCount"
                                        show-size-picker :page-sizes="netzone_pageSizes">
                                        <template #prefix="{ itemCount, startIndex }">
                                            共 {{ netzone_count }} 项
                                        </template>
                                    </n-pagination>
                    ...
                    <div style="width: 50%; display: inline-block; padding: 10px">
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="网络属性搜索" v-model:value="net_attribute_keyword"
                                        @keyup.enter.native="net_attributefilter_func"></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="attribute_page" :page-count="attribute_pageCount"
                                        show-size-picker :page-sizes="attribute_pageSizes">
                                        <template #prefix="{ itemCount, startIndex }">
                                            共 {{ attribute_count }} 项
                                        </template>
                                    </n-pagination>
                    ...
                    <div style="width: 50%; display: inline-block; padding: 10px">
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="网络架构搜索" v-model:value="net_framework_keyword"
                                        @keyup.enter.native="net_frameworkfilter_func"></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="framework_page" :page-count="framework_pageCount"
                                        show-size-picker :page-sizes="framework_pageSizes">
                                        <template #prefix="{ itemCount, startIndex }">
                                            共 {{ framework_count }} 项
                                        </template>
                                    </n-pagination>
                            ...
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="网络机柜搜索" v-model:value="net_rack_keyword"
                                        @keyup.enter.native="net_rackfilter_func"></n-input>
                                </n-space>
                            </template>
                            <template #default>
                                <n-data-table :data="rack_list.slice((rack_page - 1) * rack_pageSize, rack_page * rack_pageSize)
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="服务器供应商搜索" @keyup.enter.native=""></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="server_vendor_page" :page-count="server_vendor_pageCount"
                                        show-size-picker :page-sizes="server_vendor_pageSizes" />
                                    <!--              <n-button  circle class="ml-1" size="tiny" type="primary" @click="refresh">-->
                                    <!--                <template #icon>-->
                                    <!--                  <n-icon>-->
                                    <!--                                        <RefreshIcon />-->
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="服务器账户搜索" @keyup.enter.native=""></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="server_account_page" :page-count="server_account_pageCount"
                                        show-size-picker :page-sizes="server_account_pageSizes" />
                                    <!--              <n-button  circle class="ml-1" size="tiny" type="primary" @click="refresh">-->
                                    <!--                <template #icon>-->
                                    <!--                  <n-icon>-->
                                    <!--                                        <RefreshIcon />-->
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="服务器型号搜索" @keyup.enter.native=""></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="server_model_page" :page-count="server_model_pageCount"
                                        show-size-picker :page-sizes="server_model_pageSizes" />
                                    <!--              <n-button  circle class="ml-1" size="tiny" type="primary" @click="refresh">-->
                                    <!--                <template #icon>-->
                                    <!--                  <n-icon>-->
                                    <!--                                        <RefreshIcon />-->
                ...
                <n-tab-pane name="账户属性维护" tab="账户属性维护">
                        ...
                        <TableBody>
                            <template #header>
                                <n-space>
                                    ...
                                    <n-input size="tiny" placeholder="管理账户搜索" @keyup.enter.native=""></n-input>
                                </n-space>
                            </template>
                            <template #default>
                            ...
                            <template #footer>
                                <div class="flex justify-center">
                                    <n-pagination v-model:page="cmdb_account_page" :page-count="cmdb_account_pageCount"
                                        show-size-picker :page-sizes="cmdb_account_pageSizes" />
                                    <!--              <n-button  circle class="ml-1" size="tiny" type="primary" @click="refresh">-->
                                    <!--                <template #icon>-->
                                    <!--                  <n-icon>-->
                                    <!--                                        <RefreshIcon />-->
                    ...
                    <!--                            <template #header>-->
                    <!--                                <n-space>-->
                    <!--                                    <n-button size="tiny" type="info" @click="add_connect_type_show = true"-->
                    <!--                                    >新增连接方式-->
                    <!--                                    </n-button>-->
                    <!--                                    <n-input size="tiny" placeholder="连接方式搜索" @keyup.enter.native=""></n-input>-->
                    <!--                                </n-space>-->
                    <!--                            </template>-->
                    <!--                            <template #default>-->
                    <!--                                <n-data-table-->
                    <!--                                        :data="-->
                    <!--                    cmdb_protocol_list.slice(-->
                    <!--                      (cmdb_protocol_page - 1) * cmdb_protocol_pageSize,-->
                    <!--                      cmdb_protocol_page * cmdb_protocol_pageSize-->
                    <!--                    )-->
                    <!--                  "-->
                    <!--                                        :columns="cmdb_protocol_tableColumns"-->
                    <!--                                        :row-key="rowKey"-->
                    <!--                                />-->
                    <!--                            </template>-->
                    <!--                            <template #footer>-->
                    <!--                                <div class="flex justify-center">-->
                    <!--                                    <n-pagination-->
                    <!--                                            v-model:page="cmdb_protocol_page"-->
                    <!--                                            :page-count="cmdb_protocol_pageCount"-->
                    <!--                                            show-size-picker-->
                    <!--                                            :page-sizes="cmdb_protocol_pageSizes"-->
                    <!--                                    />-->
                    <!--                                    &lt;!&ndash;              <n-button  circle class="ml-1" size="tiny" type="primary" @click="refresh">&ndash;&gt;-->
        ...
        <n-modal v-model:show="add_model_show" preset="dialog" title="新增硬件型号">
            <div>
                <n-form :model="add_model_form" label-placement="left" label-width="auto">
                    ...
                    <n-form-item label="供应商">
                        <n-select v-model:value="add_model_form.vendor" filterable placeholder="选择供应商"
                            :options="vendor_options">
                        </n-select>
                    </n-form-item>
                </n-form>
            ...
            <div>
                <n-form :model="add_netzone_form" label-placement="left" label-width="auto">
                    ...
                    <n-form-item label="关联机房">
                        <n-select v-model:value="add_netzone_form.idc" filterable placeholder="选择关联机房"
                            :options="idc_options">
                        </n-select>
                    </n-form-item>
...
export default defineComponent({
    ...
    setup() {
                    ...
                    // },
                    {
                        ...
                        render: (rowData) => {
                            return h(
                                ...
                                {
                                    trigger: () =>
                                        h(NButton, { type: 'error', size: 'tiny' }, () => h('span', {}, '删除')),
        ...
        function model_filter_func() {
            ...
            if (model_keyword.value) {
                ...
                filter_list = model_list.filter((item) => {
                    return (item.name + item.vendor_name).indexOf(model_keyword.value) != -1
                })
                nextTick(() => {
                    model_list.length = 0
        ...
        function net_rackfilter_func() {
            ...
            if (net_rack_keyword.value) {
                ...
                filter_list = rack_list.filter((item) => {
                    return (
                        (item.name + item.idc_name + item.idc_model_name).indexOf(net_rack_keyword.value) !=
                        -1
                    )
                })
                nextTick(() => {
        ...
        function AddCmdbAccountConfirm() {
            ...
            post_data.append('enable_password', add_cmdb_account_form.value['enable_password'])
            ...
            post_data.append('user_role', add_cmdb_account_form.value['user_role'].toString())
            post({
                url: getcmdb_accountList,
                data: post_data,
            }).then((res) => {
