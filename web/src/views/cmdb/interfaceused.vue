<template>
  <div class="main-container">
    ...
    <n-modal
      ...
      :mask-closable="false"
    >
      <InterfaceUsedChart ref="interfaceUsedChart"
    /></n-modal>
  </div>
</template>
...
import InterfaceUsedChart from './chart/InterfaceUsedChart.vue'
      ...
      useTableColumn(
        [
          ...
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_10m ? rowData.int_used_10m : 0) +
                '/' +
                (rowData.int_used_10m + rowData.int_unused_10m)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_100m ? rowData.int_used_100m : 0) +
                '/' +
                (rowData.int_used_100m + rowData.int_unused_100m)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_1g ? rowData.int_used_1g : 0) +
                '/' +
                (rowData.int_used_1g + rowData.int_unused_1g)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_10g ? rowData.int_used_10g : 0) +
                '/' +
                (rowData.int_used_10g + rowData.int_unused_10g)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_20g ? rowData.int_used_20g : 0) +
                '/' +
                (rowData.int_used_20g + rowData.int_unused_20g)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_25g ? rowData.int_used_25g : 0) +
                '/' +
                (rowData.int_used_25g + rowData.int_unused_25g)
              )
            }
          },

          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_40g ? rowData.int_used_40g : 0) +
                '/' +
                (rowData.int_used_40g + rowData.int_unused_40g)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_100g ? rowData.int_used_100g : 0) +
                '/' +
                (rowData.int_used_100g + rowData.int_unused_100g)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_200g ? rowData.int_used_200g : 0) +
                '/' +
                (rowData.int_used_200g + rowData.int_unused_200g)
              )
            }
          },
          {
            ...
            render(rowData) {
              return (
                (rowData.int_used_400g ? rowData.int_used_400g : 0) +
                '/' +
                (rowData.int_used_400g + rowData.int_unused_400g)
              )
            }
          }
        ],
