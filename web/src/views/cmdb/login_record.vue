...
import { getLoginRecordList } from '@/api/url'
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableColumns = reactive(
      useTableColumn(
        [
          ...
          //         type: 'success',
          //         size: 'tiny',
          //         onClick: log_video_show_old.bind(null, rowData),
          //       },
          //       () => h('span', {}, '老版回放')
          //     )
          //   },
    ...
    function setSrc() {
      log_src.value = '/media/' + row_data.value['admin_record_file']
      console.log(log_src.value)
    }
    ...
    function log_video_show_old(item: any) {
      log_src.value = 'https://netops.iflytek.com/asset/admin_play/' + item.id
      let url = window.location.host
      window.open(
        log_src.value,
        'newwindow',
