        ...
        >
          ...
          <template #top-right>
            ...
            <n-button type="warning" size="small" @click="btnClick">
              表格导入</n-button
            >
            <n-button type="success" size="small" @click="export_excel">
              表格导出</n-button
            >
      ...
      >
        ...
        <template #footer>
          <div class="flex justify-end">
            <n-button type="default" size="small" @click="onCancelCollect"
              >取消</n-button
            >
            <n-button type="info" size="small" @click="NewConnectCollect"
              >确认</n-button
            >
...
export default defineComponent({
  ...
  setup() {
                      ...
                      () =>
                        h(
                          ...
                          ' ' +
                            ...
                            '/' +
                            (Number(int_used_obj.value['int_used_1g']) +
                              Number(int_used_obj.value['int_unused_1g']))
                        )
                    ),
                    h(
                      NFormItem,
                      {
                        ...
                        hidden: !int_used_obj.value['int_used_10g']
                      },
                      () =>
                        h(
                          'span',
                          ...
                          '' +
                            ...
                            '/' +
                            (Number(int_used_obj.value['int_used_10g']) +
                              Number(int_used_obj.value['int_unused_10g']))
                        )
                    ),
                    h(
                      NFormItem,
                      ...
                      () =>
                        h(
                          ...
                          ' ' +
                            ...
                            '/' +
                            (Number(int_used_obj.value['int_used_40g']) +
                              Number(int_used_obj.value['int_unused_40g']))
                        )
                    ),
                    h(
                      NFormItem,
                      {
                        ...
                        hidden: !int_used_obj.value['int_used_100g']
                      },
                      () =>
                        h(
                          'span',
                          ...
                          '' +
                            ...
                            '/' +
                            (Number(int_used_obj.value['int_used_100g']) +
                              Number(int_used_obj.value['int_unused_100g']))
                        )
                    ),
                    h(
                      NFormItem,
                      {
                        ...
                        hidden: !int_used_obj.value['int_used_200g']
                      },
                      () =>
                        h(
                          'span',
                          {},
                          '' +
                            int_used_obj.value['int_used_200g'] +
                            '/' +
                            (Number(int_used_obj.value['int_used_200g']) +
                              Number(int_used_obj.value['int_unused_200g']))
                        )
                    ),
                    h(
                      NFormItem,
                      {
                        ...
                        hidden: !int_used_obj.value['int_used_400g']
                      },
                      () =>
                        h(
                          'span',
                          {},
                          '' +
                            int_used_obj.value['int_used_400g'] +
                            '/' +
                            (Number(int_used_obj.value['int_used_400g']) +
                              Number(int_used_obj.value['int_unused_400g']))
                        )
                    ),
                    h(
                      NFormItem,
                      {
                        ...
                        hidden: !int_used_obj.value['int_used_auto']
                      },
                      () =>
                        h(
                          'span',
                          {},
                          '' +
                            int_used_obj.value['int_used_auto'] +
                            '/' +
                            (Number(int_used_obj.value['int_used_auto']) +
                              Number(int_used_obj.value['int_unused_auto']))
                        )
                    ),
                    h(
                      NFormItem,
                      ...
                      () =>
                        h(
                          ...
                          '' +
                            ...
                            '/' +
                            Number(int_used_obj.value['int_total'])
                        )
                    )
                  ]
                ),
                    ...
                    h(
                      ...
                      () =>
                        h(
                          'span',
                          {},
                          '' + rowData.plan_name ? rowData.plan_name : '无'
                        )
                    )
                  ]
                )
    ...
    const int_used_obj = ref({
      ...
      int_total: ref(0),
      int_used_auto: ref(0),
      int_unused_auto: ref(0),
      int_used_1g: ref(0),
      int_unused_1g: ref(0),
      int_used_10g: ref(0),
      int_unused_10g: ref(0),
      int_used_40g: ref(0),
      int_unused_40g: ref(0),
      int_used_100g: ref(0),
      int_unused_100g: ref(0),
      int_used_200g: ref(0),
      int_unused_200g: ref(0),
      int_used_400g: ref(0),
      int_unused_400g: ref(0)
    })
    const current_row_data = ref({
      bind_ip: []
    })
    ...
    function template_wait() {
      message.info('正在下载导入模板,请稍等')
    }
    function btnClick() {
    ...
    function exportData(event: { currentTarget: { files: any[] } }) {
      let f = event.currentTarget.files[0]
      const import_data = new FormData()
      // let csrf_token = Cookies.get('csrftoken')
      message.info('请稍候..表格数据正在导入')
    ...
    function doRefresh() {
      // device_import_template_url.value = ''
    ...
    function EditConfirm() {
      ...
      edit_formdata.append('zone', device_info['zone'])
    ...
    function get_info_by_idc_model(item: any) {
    ...
    function change_handleClick(item: { id: any }) {
    ...
    function handleCheck(rowKeys: never[]) {
    ...
    function ConnectAccountConfirm() {
      ...
      account_data.append('asset_id', device_info.value.toString())
      account_data.append(
        'account',
