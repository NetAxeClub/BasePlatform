<template>
    <div class="main-container">
        <TableBody>
            ...
            <template #default>
                <DataForm ref="searchForm" :form-config="{ labelWidth: 60 }" :options="conditionItems"
                          preset="grid-item"/>
        ...
        <n-modal v-model:show="collect_modalDialog" class="modal-dialog-wrapper" header-style="padding: 10px 20px"
            ...
            <n-card style="width: 600px" title="关联采集方案" :bordered="false" size="huge" role="dialog" aria-modal="true">
                <n-form ref="formRef" :model="formRef" label-placement="left" label-align="left" :label-width="160"
                        :style="{
                    maxWidth: '640px',
                }">
