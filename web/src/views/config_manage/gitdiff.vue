              ...
              <n-form ref="formRef" :label-width="80" :size="size">
                <n-grid :cols="24" :x-gap="24">
                  <n-form-item-gi :span="8" label="开始commit">
                    <n-select
                      v-model:value="from_commit"
                      filterable
                      :options="commit_option"
                    />
                  </n-form-item-gi>
                  <n-form-item-gi :span="8" label="结束commit">
                    <n-select
                      v-model:value="to_commit"
                      filterable
                      :options="commit_option"
                    />
                  </n-form-item-gi>
                  <n-form-item-gi :span="4">
                    <n-button type="primary" @click="getCommitData">
                      查询
                    </n-button>
                  </n-form-item-gi>
                  <n-form-item-gi :span="4" label="显示当前内容">
                    <n-switch
                      @update:value="switch_ace_show"
                      v-model:value="switch_source_code"
                    />
                  </n-form-item-gi>
                </n-grid>
              </n-form>
            ...
            <n-form ref="form_commit_trace" :label-width="80" :size="size">
              <n-grid :cols="24" :x-gap="24">
                <n-form-item-gi :span="12" label="指定commit">
                  <n-select
                    v-model:value="commit_value"
                    :options="commit_option"
                  />
                </n-form-item-gi>
                <n-form-item-gi :span="4">
                  <n-button type="primary" @click="getCommitHistory">
                    查询
                  </n-button>
                </n-form-item-gi>
              </n-grid>
